...
bool RenderSettingsLayer::setup() {
    ...
    argsInput->->setAnchorPoint({ 0.5f, 0.5f });
    ...
    audioArgsInput->->setAnchorPoint({ 0.5f, 0.5f });
    ...
    videoArgsInput->->setAnchorPoint({ 0.5f, 0.5f });
    ...
    secondsInput->->setAnchorPoint({ 0.5f, 0.5f });
