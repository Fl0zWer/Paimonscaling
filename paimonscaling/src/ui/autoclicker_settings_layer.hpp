...
private:
	...
	void updateInputs() {
		...
		holdInput->getInputNode()->->setOpacity(g.autoclickerP1 ? 255 : 100);
		if (!g.autoclickerP1) {
		...
		holdInput2->getInputNode()->->setOpacity(g.autoclickerP2 ? 255 : 100);
		if (!g.autoclickerP2) {
		...
		releaseInput->getInputNode()->->setOpacity(g.autoclickerP1 ? 255 : 100);
		if (!g.autoclickerP1) {
		...
		releaseInput2->getInputNode()->->setOpacity(g.autoclickerP2 ? 255 : 100);
		if (!g.autoclickerP2) {
