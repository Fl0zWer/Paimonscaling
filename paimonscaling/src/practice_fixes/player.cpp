...
PlayerData PlayerPracticeFixes::saveData(PlayerObject* player) {
    ...
    data./* TODO: Adaptar m_gv0096 a nueva versión del SDK */ = player->/* TODO: Adaptar m_gv0096 a nueva versión del SDK */;
    data./* TODO: Adaptar m_gv0100 a nueva versión del SDK */ = player->/* TODO: Adaptar m_gv0100 a nueva versión del SDK */;
    ...
    data./* TODO: Adaptar m_ringOrStreakRelated a nueva versión del SDK */ = player->/* TODO: Adaptar m_ringOrStreakRelated a nueva versión del SDK */;
    ...
    data./* TODO: Adaptar m_gamevar0060 a nueva versión del SDK */ = player->/* TODO: Adaptar m_gamevar0060 a nueva versión del SDK */;
    data.m_swapColors = player->m_swapColors;
    data./* TODO: Adaptar m_gamevar0062 a nueva versión del SDK */ = player->/* TODO: Adaptar m_gamevar0062 a nueva versión del SDK */;
    ...
    data./* TODO: Adaptar m_robotHasRun3 a nueva versión del SDK */ = player->/* TODO: Adaptar m_robotHasRun3 a nueva versión del SDK */;
    data./* TODO: Adaptar m_robotHasRun2 a nueva versión del SDK */ = player->/* TODO: Adaptar m_robotHasRun2 a nueva versión del SDK */;
    data./* TODO: Adaptar m_item20 a nueva versión del SDK */ = player->/* TODO: Adaptar m_item20 a nueva versión del SDK */;
...
void PlayerPracticeFixes::applyData(PlayerObject* player, PlayerData data, bool isPlayer2, bool isFakePlayer) {
    ...
    player->/* TODO: Adaptar m_ringOrStreakRelated a nueva versión del SDK */ = data./* TODO: Adaptar m_ringOrStreakRelated a nueva versión del SDK */;
    ...
    player->/* TODO: Adaptar m_gamevar0060 a nueva versión del SDK */ = data./* TODO: Adaptar m_gamevar0060 a nueva versión del SDK */;
    player->m_swapColors = data.m_swapColors;
    player->/* TODO: Adaptar m_gamevar0062 a nueva versión del SDK */ = data./* TODO: Adaptar m_gamevar0062 a nueva versión del SDK */;
    ...
    player->/* TODO: Adaptar m_robotHasRun3 a nueva versión del SDK */ = data./* TODO: Adaptar m_robotHasRun3 a nueva versión del SDK */;
    player->/* TODO: Adaptar m_robotHasRun2 a nueva versión del SDK */ = data./* TODO: Adaptar m_robotHasRun2 a nueva versión del SDK */;
    player->/* TODO: Adaptar m_item20 a nueva versión del SDK */ = data./* TODO: Adaptar m_item20 a nueva versión del SDK */;
