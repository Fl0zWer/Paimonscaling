...
class $modify(PlayLayer) {
    ...
    void showNewBest(bool po, int p1, int p2, bool p3, bool p4, bool p5) {
        // Always grant rewards, disable safe mode checks
    ...
    void levelComplete() {
        ...
        // Always grant rewards, disable safe mode and test mode restrictions
...
class $modify(EndLevelLayer) {
    ...
    void customSetup() {
        ...
        // Remove any safe mode reward restriction UI labels
...
class $modify(GJGameLevel) {
    ...
    void savePercentage(int p0, bool p1, int p2, int p3, bool p4) {
        // Always allow saving percentage, disable safe mode checks
